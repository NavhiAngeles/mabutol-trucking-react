...
export default function Sidebar() {
  ...
  // Set initial open states based on current route when the app loads
  useEffect(() => {
  ...
  const toggleReports = (e) => {
    ...
    setSettingsOpen(false); // Close settings when reports opens
  };

  const toggleSettings = (e) => {
    e.preventDefault();
    setSettingsOpen((prev) => !prev);
    setReportsOpen(false); // Close reports when settings opens
  };
    ...
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        ...
        <div className="nav-group">
          <div
            className={`nav-item ${isParentActive("/report") ? "active" : ""}`}
          ...
          {/* React Conditional Check: Only renders if reportsOpen is true */}
          {reportsOpen && (
        ...
        <div className="nav-group">
          <div
            className={`nav-item ${isParentActive("/settings") ? "active" : ""}`}
          ...
          {/* React Conditional Check: Only renders if settingsOpen is true */}
          {settingsOpen && (
            <div className="submenu">
